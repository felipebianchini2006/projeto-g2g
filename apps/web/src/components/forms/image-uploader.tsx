...
export function ImageUploader({
    ...
    return (
        <div className={`space-y-4 ${className}`}>
            {/* Header removed from here, handled by parent */}
            ...
            {hasFiles ? (
                ...
                <div
                    className={`group relative flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed py-8 text-center transition-all ${dragActive
                    ...
                    onClick={triggerInput}
                >
                    <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-white text-meow-400 shadow-sm transition group-hover:scale-110 group-hover:text-meow-500">
                        <UploadCloud size={24} />
                    </div>
